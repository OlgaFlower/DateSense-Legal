...
Sie sind allein verantwortlich für die Inhalte, die Sie in die App eingeben, einschließlich Notizen, Antworten, Bewertungen und beziehungsbezogener Angaben.

Sie verpflichten sich, die App nicht zu nutzen, um rechtswidrige, beleidigende, verleumderische, belästigende, hasserfüllte oder anderweitig schädliche Inhalte hochzuladen, zu speichern oder zu übermitteln.

Sie sind dafür verantwortlich, wie Sie die von der App erzeugten Einsichten auslegen und verwenden.
...
Diese Inhalte bleiben auf Ihrem Gerät. Sie werden nicht auf unsere Server übertragen, nicht an andere Nutzer weitergegeben und niemals verwendet, um die beschriebene Person zu identifizieren oder zu kontaktieren.
...
Abonnements verlängern sich automatisch, sofern sie nicht mindestens 24 Stunden vor Ende des laufenden Abrechnungszeitraums gekündigt werden.

Sie können Abonnements in den Einstellungen Ihres Apple-Kontos verwalten und kündigen.

Preise sowie Abrechnungs- und Verlängerungsbedingungen, die in der App oder auf der App-Store-Seite angezeigt werden, sind Bestandteil Ihrer Kaufbedingungen.
...
Wenn ein Abonnement endet oder nicht verlängert wird und Sie mehr als drei Personen gespeichert haben:

- **es wird nichts gelöscht.** Ihre Einträge und Fotos bleiben auf Ihrem Gerät;
- Sie werden gebeten zu wählen, welche drei Personen offen bleiben;
- die übrigen Einträge werden gesperrt. Sie sehen weiterhin, dass sie vorhanden sind, und können sie löschen, aber nicht öffnen oder bearbeiten;
- ein erneutes Abonnement gibt sofort alle Einträge wieder frei, genau so, wie sie waren.
...
- die App nicht in einer Weise zu nutzen, die Rechte Dritter verletzt.
...
Das Löschen der App löscht Ihr Konto nicht automatisch, sofern Sie nicht zusätzlich die verfügbare Funktion zur Kontolöschung verwenden.
